...
/*   Updated: 2024/02/01 17:06:06 by ibeliaie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((vars->map[y + 1][x] != '1') && vars->path.path_map[y + 1][x] < 1)
	{
		if (vars->map[y + 1][x] == 'C')
			vars->path.collectible++;
...
{
	if ((vars->map[y][x + 1] != '1') && vars->path.path_map[y][x + 1] < 1)
	{
		if (vars->map[y][x + 1] == 'C')
			vars->path.collectible++;
